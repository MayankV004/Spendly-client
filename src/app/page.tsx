...
import { ArrowRight, BarChart3, PieChart, TrendingUp, Shield, Smartphone, Zap, Menu, X } from "lucide-react"
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center items-center px-4 sm:px-0">
            <Link href="/auth/signup" className="w-full sm:w-auto">
              <Button size="lg" className="w-full sm:w-auto text-base sm:text-lg px-8 py-3 sm:py-4 h-12 sm:h-14">
                Get Started
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8">
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardTitle className="text-lg sm:text-xl mb-2">Visual Analytics</CardTitle>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardTitle className="text-lg sm:text-xl mb-2">Expense Tracking</CardTitle>
              <CardDescription className="text-sm sm:text-base leading-relaxed">
                Categorize and track all your expenses with smart categorization and detailed insights
              </CardDescription>
            </CardHeader>
          </Card>
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardTitle className="text-lg sm:text-xl mb-2">Goal Setting</CardTitle>
              <CardDescription className="text-sm sm:text-base leading-relaxed">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardTitle className="text-lg sm:text-xl mb-2">Secure & Private</CardTitle>
              <CardDescription className="text-sm sm:text-base leading-relaxed">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              ...
              <CardTitle className="text-lg sm:text-xl mb-2">Mobile Ready</CardTitle>
              <CardDescription className="text-sm sm:text-base leading-relaxed">
          ...
          <Card className="border-0 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 active:scale-95">
            <CardHeader className="p-6 sm:p-8">
              <div className="w-12 h-12 sm:w-14 sm:h-14 bg-indigo-100 rounded-lg flex items-center justify-center mb-4">
                <Zap className="h-6 w-6 sm:h-7 sm:w-7 text-indigo-600" />
              </div>
              <CardTitle className="text-lg sm:text-xl mb-2">Smart Insights</CardTitle>
              <CardDescription className="text-sm sm:text-base leading-relaxed">
                AI-powered insights and recommendations to optimize your spending habits
              </CardDescription>
            </CardHeader>
          </Card>
        </div>
        ...
        <Card className="bg-gradient-to-r from-blue-600 to-purple-600 border-0 text-white mx-auto">
          <CardContent className="p-8 sm:p-10 md:p-12 text-center">
            ...
            <Link href="/auth/signup" className="inline-block w-full sm:w-auto">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto text-base sm:text-lg px-8 py-3 sm:py-4 h-12 sm:h-14 bg-white text-blue-600 hover:bg-gray-50">
                Get Started Today
                <ArrowRight className="ml-2 h-4 w-4 sm:h-5 sm:w-5" />
              </Button>
            </Link>
